...
| `ios-game-developer` | iOS game implementation specialist (Swift / SpriteKit / SceneKit / Metal / GameplayKit) — logic/render separation, frame budget, tested/clean code, review, refactoring |
